    ...
    <div className={styles.container}>
      ...
      <div className={styles.socials}>
        ...
        <Link to="https://soundcloud.com/wgtb-rotation">
          <StaticImage
            ...
            alt="Soundcloud"
            className={styles.imageSoundcloud}
          />
        </Link>
      ...
      <div className={styles.footerWrap}>
        <div className={styles.footerColumn}>
          <h3 className={styles.footerHeader}>Blogroll</h3>
          <ul>
            <li>
        ...
        <div className={styles.footerColumn}>
          <h3 className={styles.footerHeader}>DC Music Venues</h3>
          <ul>
            <li>
        ...
        <div className={styles.footerColumn}>
          <h3 className={styles.footerHeader}>Our Location</h3>
          <div>
            <p>
              432 Leavey Center <br />
